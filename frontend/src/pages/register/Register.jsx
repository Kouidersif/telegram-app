            ...
            <div className="w-full max-w-md">
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Or <Link to="/login" className="font-medium text-primary-600 hover:underline dark:text-primary-500">login</Link> with existing account
                    </p>
                </div>
                <form className="flex max-w-md flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <TextInput name="password" id="password1" placeholder="********" type="password" required />
                    </div>
